...
|------|-------------|------|---------|:--------:|
| <a name="input_ami"></a> [ami](#input\_ami) | AMI ID for the instance | `string` | n/a | yes |
| <a name="input_subnet_id"></a> [subnet\_id](#input\_subnet\_id) | ID of the subnet to launch in | `string` | n/a | yes |
...
| <a name="input_monitoring_enabled"></a> [monitoring\_enabled](#input\_monitoring\_enabled) | Whether detailed monitoring is enabled | `bool` | `true` | no |
...
| <a name="input_user_data"></a> [user\_data](#input\_user\_data) | User data script (plain text) | `string` | `null` | no |
...
| <a name="output_id"></a> [id](#output\_id) | ID of the EC2 instance |
